export class JsonDrawCardInformation {
    ...
    /**是否限时 */
    public IfLimit:number = 0 ;
    /**限时时间 */
    public LimitTime:number = 0 ;
    /**英雄ID */
    public HeroStandID:number = 0 ;
    /**背景图片文件名 */
    public BgID:string = '' ;
}
...
export class DrawCardInformationManager {
    ...
    /**根据卡池ID获取是否限时 */
    public getIfLimit(id:number): number {
        return this.data.get(id).IfLimit;
    }
    /**根据卡池ID获取限时时间 */
    public getLimitTime(id:number): number {
        return this.data.get(id).LimitTime;
    }
    /**根据卡池ID获取英雄ID */
    public getHeroStandID(id:number): number {
        return this.data.get(id).HeroStandID;
    }
    /**根据卡池ID获取背景图片文件名 */
    public getBgID(id:number): string {
        return this.data.get(id).BgID;
    }
