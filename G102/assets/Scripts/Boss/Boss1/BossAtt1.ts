...
@ccclass
export default class BossAtt1 extends BossBullet {
            ...
            switch(this.bullet_type){
                case 0:{
                    ...
                    if(data.getDamageNum()>0){
                        GameEffectsManager.getInstance().createGameEffectById(GameEffectId.boss1_normal_att_hit,this.node.getPosition());
                ...
                case 1:{
                    ...
                    super.destroySelf();
                    if(data.getDamageNum()>0){
                        GameEffectsManager.getInstance().createGameEffectById(GameEffectId.boss1_normal_skill_hit,this.node.getPosition());
                        GameManager.getInstance().sound_manager.playSound(SoundIndex.YX_Boss1Attack);
                    }
                }break;
