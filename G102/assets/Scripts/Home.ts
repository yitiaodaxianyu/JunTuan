...
export default class Home extends cc.Component {
    ...
    {  
        ...
        // },});//转盘
        // return;
        UIManager.getInstance().showUiDialog(UIPath.Set,UILayerLevel.One,{onCompleted:(uiNode)=> {
    ...
    clickBtnBag(){
        ...
        UIManager.getInstance().showUiDialog(UIPath.Bag,UILayerLevel.One,{onCompleted:(uiNode)=> {
