...
export class SkillConfigurationManager {
    ...
    getJsonDataByHeroTypeAndSkillPosAndSkillLevel(heroType:Hero_Type,sillPos:number,skillLevel:number):JsonSkillConfiguration{
        let info:JsonSkillConfiguration = null;
    ...
    public static GetSkillId(heroType:Hero_Type,skillPos:number,skillLevel:number):number{
